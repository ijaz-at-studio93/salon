...
class SalonTransactionData {
  ...
  SalonTransactionData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['booking'] != null) {
      ...
      /// 🔥 FIXED: items mapping from booking
      if (booking['items'] != null) {
        items = <SalonTransactionItem>[];
        booking['items'].forEach((v) {
          items!.add(SalonTransactionItem.fromJson(v));
        });
      }

      /// 🔥 OPTIONAL: artist mapping (if backend sends)
      if (booking['artist'] != null) {
        appointment = SalonTransactionAppointment.fromJson({
          "id": booking['id'],
          "salonArtistId": booking['artist']['id'],
