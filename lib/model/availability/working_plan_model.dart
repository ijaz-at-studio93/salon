import 'artiest_availability_get_model.dart';

class WorkingPlanModel {
  Availability? workingPlan;

  WorkingPlanModel({this.workingPlan});

  WorkingPlanModel.fromJson(Map<String, dynamic> json) {
    workingPlan = json['workingPlan'] != null
        ? Availability.fromJson(json['workingPlan'])
        : null;
  }
...
class WorkingPlan {
  ...
  WorkingPlan.fromJson(Map<String, dynamic> json) {
    sunday = json['sunday'] != null ? DayWorkData.fromJson(json['sunday']) : null;
    monday = json['monday'] != null ? DayWorkData.fromJson(json['monday']) : null;
    tuesday = json['tuesday'] != null ? DayWorkData.fromJson(json['tuesday']) : null;
    wednesday =
        json['wednesday'] != null ? DayWorkData.fromJson(json['wednesday']) : null;
    thursday =
        json['thursday'] != null ? DayWorkData.fromJson(json['thursday']) : null;
    friday = json['friday'] != null ? DayWorkData.fromJson(json['friday']) : null;
    saturday =
        json['saturday'] != null ? DayWorkData.fromJson(json['saturday']) : null;
  }
