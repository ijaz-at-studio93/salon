                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _homeController.getAppointmentDetailsModel.data
                                        ?.taxDetails?.allTaxDetails?.isEmpty ??
                                    false
                                ? const SizedBox()
                                : Column(
                                    children: [
                                      _customerDetails(
                                          titleName: "Tax Applied",
                                          titleValue:
                                              "${_homeController.getAppointmentDetailsModel.data?.taxDetails?.allTaxDetails?[0].percentage}%"),
                                      const SizedBox(height: 10),
                                      _customerDetails(
                                          titleName: "Total TaxAmount",
                                          titleValue:
                                              "${_homeController.getAppointmentDetailsModel.data?.taxDetails?.totalTaxAmount}"),
                                      const SizedBox(height: 10),
                                      Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 20),
