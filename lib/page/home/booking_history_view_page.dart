...
import '../stylist_all_module/stylist_home_page/bokking_overview/upload_photo_page.dart';
              ...
              child: Column(
                children: [
                  ...
                  _invoiceWidget(
                    title: "Slot Time",
                    subTitle: "Status",
                    subtitleValue: _homeController.getAppointmentDetailsModel.data?.orderStatus ?? '',
                    ...
                    Expanded(
                      child: ScrollbarTheme(
                          data: ScrollbarThemeData(
                            thumbColor: MaterialStateProperty.all(ColorConstant.primaryColor),
                          ),
                          child: Scrollbar(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "Rs. ${_homeController.getAppointmentDetailsModel.data?.items!.fold<double>(0.0,
                            (sum, item) => sum + (item.service?.price ?? 0)) ?? 0}",
                    style: AppTextTheme.bold.copyWith(
                      fontSize: 20,
                      color: ColorConstant.blackColor,
                    ),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    final status = _homeController.getAppointmentDetailsModel.data?.orderStatus;
                    final token  = _homeController.qrToken[widget.appointmentId]; // if you stored it
                            ...
                            if (allow) {
                              Get.dialog(
                                PortfolioPermissionDialog(
                                  yes: () {
                                    Get.back();
                                    Get.to(() => UploadImagePage(appointmentId: widget.appointmentId));
                                  },
                                  cancel: () {
                                    Get.back();
                                    Get.back();
                  ...
                  child: Text(
                    (_homeController.getAppointmentDetailsModel.data?.orderStatus == 'pending')
                        ? "Accept"
                        : (_homeController.getAppointmentDetailsModel.data?.orderStatus == 'confirmed')
                        ? "Mark As Done" : "",
