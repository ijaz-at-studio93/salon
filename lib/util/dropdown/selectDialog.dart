...
class _SelectDialogState<T> extends State<SelectDialog<T>> {
  ...
  final GlobalKey<PaginationViewState> _paginationViewState =
                  ...
                  builder: (context, snapshot) {
                    if (widget.onLoadMore != null) {
                      return PaginationView<T>(
                        key: _paginationViewState,
                        shrinkWrap: true,
                        onEmpty: widget.emptyBuilder != null
                            ? widget.emptyBuilder!(
                                context,
                                widget.searchFieldProps?.controller?.text ??
                                    widget.searchBoxController?.text,
                        ...
                        itemBuilder: (context, item, i) => _itemWidget(item),
                      ...
                      if (snapshot.hasError) {
                        ...
                        if (widget.emptyBuilder != null) {
                          ...
                          return   Center(
                            child: Text("No results are found",style: Get.textTheme.labelLarge?.copyWith(
                              color: Colors.white,
                              fontSize: 16
                            ),),
                          );
  ...
  void manageItemsByFilter(String filter, {bool isFistLoad = false}) async {
    ...
    if (widget.onLoadMore != null) {
      _paginationViewState.currentState?.refresh();
    } else if (widget.onFind != null &&
        (widget.isFilteredOnline || isFistLoad)) {
      try {
    ...
    if (widget.itemBuilder != null) {
      ...
      return ListTile(
        title: Text(_selectedItemAsString(item),
            style: widget.itemDisabled != null &&
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
              ...
              textCapitalization: widget.searchFieldProps?.textCapitalization ??
